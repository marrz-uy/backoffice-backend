...
{
    public function test_Consultar_Transportes()
    {
        $response = $this->get('/api/PuntosInteres/transporte');

        $response->assertStatus(200);
    }
    public function test_Registrar_Transporte_Exitoso(){
        $response = $this->withHeaders([
            ...
            "InformacionDetalladaPuntoDeInteres" => "{\"Tipo\":\"Omnibus\",\"Op\":\"transporte\"}"
